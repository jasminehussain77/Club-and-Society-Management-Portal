...
--
-- Host: localhost    Database: club_portal
-- ------------------------------------------------------
...
CREATE TABLE `memberships` (
  ...
  `join_attempts` int(11) DEFAULT 0,
...
-- Dump completed on 2026-03-30 22:54:45
